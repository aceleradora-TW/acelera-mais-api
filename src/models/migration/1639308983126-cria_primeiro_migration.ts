...
export class criaPrimeiroMigration1639308983126 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "exercise" ("id" SERIAL NOT NULL, "time_stamp" TIMESTAMP WITH TIME ZONE, "address_email" character varying NOT NULL, "name" character varying, "phone" character varying, "exercise" character varying, "file_type" character varying, "file_zip" character varying, "file_github" character varying, "have_computer" character varying, "have_internet" character varying, "have_webcam" character varying, "can_use_webcam" character varying, "city_state" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "hiring_process_id" integer, "exercise_id" integer, CONSTRAINT "REL_d1650f62d215bae2e6f2acdce9" UNIQUE ("exercise_id"), CONSTRAINT "PK_a0f107e3a2ef2742c1e91d97c14" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "exercise" ADD CONSTRAINT "FK_ccc93ccd1dbcc4c88d464a1cafa" FOREIGN KEY ("hiring_process_id") REFERENCES "hiring_process"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "exercise" ADD CONSTRAINT "FK_d1650f62d215bae2e6f2acdce98" FOREIGN KEY ("exercise_id") REFERENCES "evaluation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "candidate" ADD CONSTRAINT "FK_5388d0834e243ab51b87e48f2b3" FOREIGN KEY ("exericse_id") REFERENCES "exercise"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "exercise" DROP CONSTRAINT "FK_d1650f62d215bae2e6f2acdce98"`);
        await queryRunner.query(`ALTER TABLE "exercise" DROP CONSTRAINT "FK_ccc93ccd1dbcc4c88d464a1cafa"`);
